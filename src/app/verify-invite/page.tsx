  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-canvas px-4">
      <div className="w-full max-w-md space-y-4">
        <Link href="/" className="inline-flex items-center gap-2 text-sm text-fg-muted hover:text-fg transition-colors">
          <ArrowLeft className="h-4 w-4" />
          Voltar para Home
        </Link>
        
        <Card className="border-edge shadow-xl">
          ...
          <CardContent>
            <form onSubmit={handleVerify} className="space-y-4">
              ...
              {error && (
                <div className="flex items-center gap-2 rounded-lg bg-destructive/10 p-3 text-sm text-danger border border-danger/20">
          ...
          <CardFooter className="flex flex-col gap-4 border-t border-edge pt-6 mt-2">
