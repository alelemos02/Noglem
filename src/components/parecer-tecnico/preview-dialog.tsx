      ...
      <DialogContent>
        ...
        <DialogBody>
          ...
          {previewResumo && !isLoading && (
            <div className="mb-4 rounded-lg bg-info-muted p-3">
          ...
          {previewItems.length > 0 && !isLoading && (
            <p className="mb-3 font-mono tabular-nums text-xs text-text-secondary">
              {previewItems.length}{" "}
          ...
          {/* Erro */}
          {previewError && (
            <div className="mb-4 rounded-lg bg-error-muted p-3">
              ...
              {previewItems.map((item) => (
                ...
                >
                  <div className="flex items-start gap-3">
                    <span className="mt-0.5 w-6 shrink-0 font-mono tabular-nums text-xs text-text-tertiary">
                      {item.numero}
                    </span>
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="text-sm text-text-primary">{item.descricao_requisito}</p>
          ...
          <div className="mt-6 space-y-2">
            ...
            <textarea
              ...
              rows={3}
              className="w-full resize-none rounded-lg border border-border bg-bg-primary px-3 py-2 text-sm text-text-primary placeholder:text-text-tertiary outline-none focus:border-accent focus:ring-1 focus:ring-accent"
            />
          </div>
        </DialogBody>
